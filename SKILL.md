...
Factoring HOT aggregates and scores news from 20+ authoritative sources in the
Chinese factoring and supply-chain finance industry. It provides daily reports,
hot topic rankings, and real-time article feeds with AI-powered scoring across
four dimensions: policy, market, risk, and innovation.
...
|-------|------|---------|-------------|
| `mode` | string | `selected` | `all` or `selected` (editor's picks only) |
| `category` | string | — | Filter: `policy`, `market`, `risk`, `innovation` |
  ...
  "items": [
    {
      ...
      "categoryLabel": "政策监管",
      "score": 85,
      "scoreDimensions": { "policy": 22, "market": 20, "risk": 18, "innovation": 25 },
      "scoringMethod": "llm",
      "selected": true
    }
  ],
...
| `/feed/category/{cat}.xml` | Category-specific feed (policy/market/risk/innovation) |

## Categories

| ID | Chinese Name | Description |
|----|-------------|-------------|
| `policy` | 政策监管 | Central bank, NFRA, regulatory policy changes |
| `market` | 市场信号 | Market trends, business model innovation |
| `risk` | 风险预警 | Industry risks, compliance issues, case studies |
| `innovation` | 创新实践 | New technology, new applications |
...
4. **Category deep dive**: Call `GET /api/public/items?category=policy&take=20`
